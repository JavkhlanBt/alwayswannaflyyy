...
\definecolor{RefBlue}{RGB}{56, 56, 176}
\definecolor{RefBlueDark}{RGB}{33, 33, 112}
\definecolor{RefBlack}{RGB}{9, 9, 12}
\definecolor{RefText}{RGB}{18, 18, 18}

\setbeamercolor{normal text}{fg=RefText,bg=white}
\setbeamercolor{structure}{fg=RefBlue}
\setbeamercolor{title}{fg=white}
\setbeamercolor{subtitle}{fg=white}
\setbeamercolor{titlelike}{fg=white,bg=RefBlue}
\setbeamercolor{frametitle left}{fg=white,bg=RefBlue}
\setbeamercolor{frametitle right}{fg=white,bg=RefBlack}
\setbeamercolor{section in head/foot}{fg=white,bg=RefBlack}
\setbeamercolor{subsection in head/foot}{fg=white,bg=RefBlack}
\setbeamercolor{palette primary}{fg=white,bg=RefBlack}
\setbeamercolor{palette secondary}{fg=white,bg=RefBlue}
\setbeamercolor{palette tertiary}{fg=white,bg=RefBlack}
\setbeamercolor{palette quaternary}{fg=white,bg=RefBlue}
\setbeamercolor{author in head/foot}{fg=white,bg=RefBlack}
\setbeamercolor{title in head/foot}{fg=white,bg=RefBlue}
\setbeamercolor{date in head/foot}{fg=white,bg=RefBlueDark}
\setbeamercolor{navigation symbols}{fg=RefBlue!55}
\setbeamercolor{title page banner}{fg=white,bg=RefBlue}
\setbeamercolor{block title}{fg=white,bg=RefBlueDark}
\setbeamercolor{block body}{fg=black,bg=black!4}
\setbeamercolor{block title example}{fg=white,bg=RefBlue}
\setbeamercolor{block body example}{fg=black,bg=black!3}
\setbeamercolor{block title alerted}{fg=white,bg=BrickRed}
\setbeamercolor{block body alerted}{fg=black,bg=black!2}
...
\setbeamertemplate{frametitle}{%
  \nointerlineskip
  \hbox{%
    \begin{beamercolorbox}[wd=.50\paperwidth,ht=3.3ex,dp=1.2ex,leftskip=.35cm]{frametitle left}%
      \usebeamerfont{frametitle}\insertframetitle
    \end{beamercolorbox}%
    \begin{beamercolorbox}[wd=.50\paperwidth,ht=3.3ex,dp=1.2ex]{frametitle right}%
    \end{beamercolorbox}%
  }%
}
...
\setbeamertemplate{title page}{%
  \begin{centering}
    \vspace*{1.2cm}
    \begin{beamercolorbox}[wd=.86\paperwidth,sep=.62cm,center,rounded=true,shadow=true]{title page banner}
...
\medskip
Хүснэгт~4.4-т blue crab агнуурын өгөгдлийг үзүүлэв.
\end{frame}
...
\begin{frame}{Теорем 1: Lagrange-ын олон гишүүнт (үргэлжлэл)}
\footnotesize
\begin{block}{Lagrange-ын хэлбэр}
